...
img_path = os.path.join(script_dir, "circlesgrid.png")

img = cv2.imread(img_path, cv2.IMREAD_COLOR)
if img is None:
    raise FileNotFoundError(
        "Input image not found. Place circlesgrid.png in the PJT_21-108 folder "
        f"or update img_path. Current path: {img_path}"
    )
